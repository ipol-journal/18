...
p.stdin.write(b'plot "code.txt" with steps title "Flutter shutter function" linewidth 1.5 \n')
...
p.stdin.write(b'set key on  below box title "Legend" \n')
p.stdin.write(b'set key left Left reverse \n')
p.stdin.write(b'plot "TF_code.txt" using 1:2 with lines title "Fourier transform (modulus) of the flutter function" linewidth 1.5 \n')
p.stdin.write(b'exit \n')
p.communicate()
